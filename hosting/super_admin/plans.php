...
if (!sa_table_exists('sa_plans')) {
    ...
    <section class="panel">
        ...
        <p class="muted">Ejecuta primero <code>hosting/sql/20260508_super_admin_connect_companies.sql</code> para habilitar planes SaaS.</p>
    </section>
    <?php
    sa_footer();
    exit;
...
<section class="panel">
    <div class="toolbar">
        <div>
            ...
            <p class="muted">Los planes preparan limites SaaS. Todavia no bloquean Rodeo Import.</p>
        </div>
