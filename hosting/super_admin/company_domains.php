...
if (!sa_table_exists('sa_company_domains')) {
    ...
    <section class="panel">
        ...
        <p class="muted">Ejecuta primero <code>hosting/sql/20260508_super_admin_connect_companies.sql</code> para habilitar dominios SaaS.</p>
    </section>
    <?php
    sa_footer();
    exit;
...
<section class="panel">
    ...
    <?php if ($selectedCompany): ?>
        <form method="post">
            ...
            <div class="form-grid">
                <label class="field">Dominio <input name="domain" value="<?= sa_e($values['domain'] ?? '') ?>" placeholder="cliente.createcgroupsolution.com" required></label>
                ...
                <label class="field">DNS target <input name="dns_target" value="<?= sa_e($values['dns_target'] ?? '') ?>" placeholder="app.createcgroupsolution.com"></label>
